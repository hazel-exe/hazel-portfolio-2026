  ...
  return (
    <section id="contact" className="py-24 px-6 bg-athens">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-black/[0.04] max-w-2xl mx-auto min-h-[400px] flex flex-col justify-center">
          {status === "success" ? (
            <motion.div
            ...
            >
              <h3 className="text-3xl font-bold text-[#007AFF] mb-4">Message Received</h3>
              <p className="text-[#8E8E93] text-lg">Thank you for reaching out! I'll get back to you shortly.</p>
            </motion.div>
          ) : (
            <form 
              className="space-y-6" 
